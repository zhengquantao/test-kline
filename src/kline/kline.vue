  ...
  <div id="kline_container">
    <div class="chart_container dark">
      ...
      <div id="chart_toolbar">
        ...
        <div class="chart_dropdown" id="chart_toolbar_periods_vert">
          ...
          <div class="chart_dropdown_data" style=" marginLeft: -58px;">
            <table>
              <tbody>
                <tr>
                  <td>
        ...
        <div id="chart_toolbar_periods_horz">
          <ul
            class="chart_toolbar_tabgroup"
            style="paddingLeft: 5px;paddingRight: 11px;"
          >
        ...
        <div
          ...
          class="chart_toolbar_button chart_str_indicator_cap selected"
        >
          技术指标
        </div>
        <div
          id="chart_show_tools"
          class="chart_toolbar_button chart_str_tools_cap"
        >
          画线工具
        </div>
        <div id="chart_toolbar_theme">
          ...
          <a name="dark" class="chart_icon chart_icon_theme_dark selected" />
          <a name="light" class="chart_icon chart_icon_theme_light" />
        </div>
              ...
              <tbody>
                  ...
                  <td>
                    <ul>
                      <li>
                        <a
                          name="dark"
                          class="chart_icon chart_icon_theme_dark selected"
                        />
                      </li>
                      <li>
                        <a
                          name="light"
                          class="chart_icon chart_icon_theme_light"
                        />
                      </li>
                    </ul>
                  </td>
                ...
                >
                  ...
                  <td>
                    <ul>
                      <li>
                        <a name="on" class="chart_str_on">
                          开启
                        </a>
                      </li>
                      <li>
                        <a name="off" class="chart_str_off selected">
                          关闭
                        </a>
                      </li>
                    </ul>
                ...
                <tr id="chart_enable_indicator" style="display: none">
                  ...
                  <td>
                    <ul>
                      <li>
                        <a name="on" class="chart_str_on selected">
                          开启
                        </a>
                      </li>
                      <li>
                        <a name="off" class="chart_str_off">
                          关闭
                        </a>
                      </li>
                    </ul>
        ...
        >
          ...
          <div
            class="chart_dropdown_data"
            style="paddingTop: 15px;marginLeft: -12px"
          >
            <ul>
              <li style="height: 25px">
                <a name="zh-cn" class="selected">
                  简体中文(zh-CN)
                </a>
              </li>
              <li style="height: 25px">
        ...
        <div id="chart_updated_time">
          <div id="sizeIcon" class="chart_BoxSize" />
        </div>

        <div
          id="chart_show_depth"
          class="chart_toolbar_button chart_str_depth_cap"
        >
          深度图
        </div>
        
        <div class="symbol-select">
          <el-select v-model="symbol" filterable placeholder="请选择">
            <el-option
      ...
      <div id="chart_toolpanel">
        ...
        <div class="chart_toolpanel_button">
          <div class="chart_toolpanel_icon" id="chart_Cursor" name="Cursor" />
        ...
        <div class="chart_toolpanel_button">
          <div class="chart_toolpanel_icon" id="chart_SegLine" name="SegLine" />
        ...
        <div class="chart_toolpanel_button">
          <div class="chart_toolpanel_icon" id="chart_RayLine" name="RayLine" />
    ...
    <div style=" display:none" id="chart_language_switch_tmp">
      ...
      <span
        ...
        en_us="Line"
      />
      <span name="chart_str_period_1m" zh_tw="1分鐘" zh_cn="1分钟" en_us="1m" />
      <span name="chart_str_period_3m" zh_tw="3分鐘" zh_cn="3分钟" en_us="3m" />
      <span name="chart_str_period_5m" zh_tw="5分鐘" zh_cn="5分钟" en_us="5m" />
      <span
...
const VueKline = {
  ...
  watch: {
    symbol(newSymbol, oldSymbol){
      if(newSymbol!==oldSymbol) this.getData();
    }
  },
  methods: {
    getData(){
    ...
    onTransactionInfo(data) {
      this.kline.onTransactionInfo(data)
    }
  }
}
